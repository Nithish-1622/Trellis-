...
export default function Chat() {
  ...
  return <div className="flex min-h-screen flex-col bg-zinc-50 text-zinc-950 dark:bg-zinc-950 dark:text-zinc-100">
    <header className="border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950"><div className="mx-auto flex h-16 max-w-4xl items-center justify-between px-4 sm:px-6"><div><h1 className="font-bold">Trellis Assistant</h1><p className="text-xs text-zinc-500">Grounded in your saved learning context</p></div><Link to="/profile" className="rounded-lg px-3 py-2 text-sm font-semibold hover:bg-zinc-100 dark:hover:bg-zinc-800">Back to dashboard</Link></div></header>
