            ...
            <div className='max-w-7xl mx-auto px-6 lg:px-8'>
                <div className={`flex flex-col md:flex-row justify-between items-center`}>
                    <div className="flex items-center gap-2 mb-4 md:mb-0">
                        <img src={trellisLogo} alt="Trellis" className="h-8 w-auto grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all duration-500" />
                        <span className={`font-bold text-lg tracking-tight ${darkMode ? 'text-zinc-200' : 'text-zinc-800'}`}>Trellis</span>
                    </div>
                    ...
                    <div className={`text-sm ${darkMode ? 'text-zinc-600' : 'text-zinc-400'}`}>
                        &copy;{new Date().getFullYear()} Trellis
                    </div>
                </div>
            </div>
        </footer>
